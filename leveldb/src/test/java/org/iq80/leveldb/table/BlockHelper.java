...
public final class BlockHelper {
    ...
    @SafeVarargs
    public static <K, V> void assertSequence(
            SeekingIterator<K, V> seekingIterator, Entry<K, V>... entries) {
    ...
    private static <K, V> void assertSequence(
            SeekingIterator<K, V> seekingIterator,
            Iterable<? extends Entry<K, V>> entries,
            Function<SeekingIterator<K, V>, Boolean> next) {
    ...
    public static <K, V> void assertReverseSequence(
            SeekingIterator<K, V> seekingIterator, Iterable<? extends Entry<K, V>> entries) {
    ...
    public static int estimateEntriesSize(int blockRestartInterval, List<BlockEntry> entries) {
        ...
        for (BlockEntry entry : entries) {
            ...
            if (restartBlockCount < blockRestartInterval) {
                nonSharedBytes =
                        entry.getKey().length()
                                - BlockBuilder.calculateSharedBytes(entry.getKey(), previousKey);
            } else {
