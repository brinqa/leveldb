...
public class InternalUserComparator implements UserComparator {
    ...
    public Slice findShortestSeparator(Slice start, Slice limit) {
        ...
        if (internalKeyComparator.getUserComparator().compare(startUserKey, shortestSeparator)
                < 0) {
    ...
    public Slice findShortSuccessor(Slice key) {
        ...
        Slice shortSuccessor =
                internalKeyComparator.getUserComparator().findShortSuccessor(userKey);
