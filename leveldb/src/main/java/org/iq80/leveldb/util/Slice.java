...
public final class Slice implements Comparable<Slice> {
    ...
    public int getInt(int index) {
        ...
        index += offset;
        return ByteArrayUtils.readInt(this.data, index);
    }
    ...
    public long getLong(int index) {
        ...
        index += offset;
        return ByteArrayUtils.readLong(this.data, index);
    }
    ...
    public void setInt(int index, int value) {
        checkPositionIndexes(index, index + SIZE_OF_INT, this.length);
        index += offset;
        ByteArrayUtils.writeInt(this.data, index, value);
    }
    ...
    public void setLong(int index, long value) {
        checkPositionIndexes(index, index + SIZE_OF_LONG, this.length);
        index += offset;
        ByteArrayUtils.writeLong(this.data, index, value);
    }
