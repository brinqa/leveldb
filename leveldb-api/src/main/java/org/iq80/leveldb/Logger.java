...
public interface Logger extends Closeable {
    ...
    /**
     * Substitutes each {@code %s} in {@code template} with an argument. Arguments without place
     * holder will be placed at the end of template.
     *
     * <p>This is a default method to avoid incompatibilities with older logger interface.
     *
